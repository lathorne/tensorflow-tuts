...
fc3 = tf.layers.dense(fc2, NUM_H3, activation=tf.nn.relu, kernel_initializer=he_init, name='fc3')
fc4 = tf.layers.dense(fc3, NUM_H4, activation=tf.nn.relu, kernel_initializer=he_init, name='fc4')
logits = tf.layers.dense(fc4, NUM_OUTPUTS, name='logits')  # this tf.layers.dense is same as tf.matmul(x, W) + b

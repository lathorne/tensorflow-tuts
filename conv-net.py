...
# Training Parameters
learning_rate = 0.001
num_steps = 5000 #number of times grabbing a batch
batch_size = 128 #how many images grabbed at a time/per step
display_step = 100 #show progress every 100 steps

# Network Parameters
NUM_INPUTS = 784 #HxWxC of all inputs (pixels)
NUM_OUTPUTS = 10 #number of output channels, you must know the output channel, but the network knows the other variables
NUM_C1 = 16 
NUM_C2 = 16
NUM_H1 = 512
NUM_H2 = 256
